    ...
    <>
      ...
      <div
        ...
        <div className="order-3 col-span-1 space-y-4 md:col-span-2 md:order-none">
          <div>
            <div className="bg-white dark:bg-neutral-800 rounded px-4 py-3 shadow space-y-2">
              <h3 className="font-extrabold text-neutral-800 dark:text-neutral-200">
                Bem vindo 👋
              </h3>
              <p className="text-neutral-500 dark:text-neutral-400">
                💀 Somos um servidor hard survival com adição de vários plugins, como proteção de chunks, geração personalizada de terrenos, novas armaduras, novos items e também novos encantamentos.
              </p>
              <p className="text-neutral-500 dark:text-neutral-400">
                📜 Antes de entrar dê uma olhada nas regras de nosso servidor. Queremos que todos tenham um ótimo momento aqui, seguindo as regras evita-se qualquer desconforto e criamos um ambiente bacana a todos.
              </p>
            </div>
          </div>
        ...
        <div className="order-1 col-span-1 space-y-4 md:order-none">
        <div className='bg-white dark:bg-neutral-800 rounded px-4 py-3 shadow'>
              <h3 className='font-extrabold text-neutral-800 dark:text-neutral-200 mb-2'>Seja um apoiador</h3>
              {/*<div >
