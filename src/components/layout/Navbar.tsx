...
export default function Navbar({}: Props) {
    return (
      <nav
          className="bg-white shadow dark:bg-cool-gray-800 z-40 w-full sticky top-0"
      >
          ...
          <div className="flex justify-between font-semibold h-14">
            <div className="left-menu-items flex space-x-4">
              ...
              <div className="hidden md:flex items-center">
                <div
                    className="items-center justify-center hidden space-x-8 md:ml-8 md:flex"
                >
                  <button>
                    <svg
                        fill="currentColor"
              ...
              <div className="hidden md:flex">
                <div
                    className="inline-flex items-center px-1 pt-1 text-sm leading-5 text-gray-500 transition duration-150 ease-in-out border-b-2 border-transparent hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300"
                >
                  <div className="relative">
                    <div>
                      ...
                      ><button
                          type="button"
                          className="inline-flex items-center py-2 text-sm font-semibold leading-4 text-gray-500 transition duration-150 ease-in-out border border-transparent rounded-md dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 focus:outline-none"
                      >
                          More
                          <svg
                    ...
                    <div
                        className="absolute z-50 mt-2 rounded-md shadow-lg w-48 origin-top-right right-0 hidden"
                        // style="display: none"
                    >
                      <div
                          className="rounded-md ring-1 ring-black ring-opacity-5 dark:bg-gray-800 py-1 bg-white"
                      >
                        <div className="text-sm">
                          <a
                              className="block px-4 py-2 text-sm leading-5 text-gray-700 dark:text-gray-400 hover:bg-cool-gray-100 dark:hover:bg-cool-gray-900 focus:outline-none focus:bg-cool-gray-100 dark:focus:bg-cool-gray-900 transition duration-150 ease-in-out"
            ...
            <div className="middle-menu-items flex space-x-4">
              ...
              <div className="flex items-center flex-shrink-0">
                ...
                ><img
                    src="/images/site_header_logo_dark.svg"
                    alt="Site Header Logo"
                    className="logo block w-auto h-9"/></a
                >
              </div>
            ...
            <div className="flex items-center -mr-2 md:hidden">
              <div
                  className="flex items-center justify-center space-x-8 md:ml-8 md:hidden"
              >
                <button>
                  <svg
                      fill="currentColor"
